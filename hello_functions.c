...
float tmep_sensor_converter(int temp_sensor_value, bool *success)
{
  ...
  // slope of a line with endpoints (TEMP_SENSE_MIN, TEMP_(_MIN) and (TEMP_SENSE_MAX, TEMP_SENSE_MAX) where temp_sense is on the x axis and temp_c is on the y axis
